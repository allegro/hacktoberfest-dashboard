import { Accordion, Anchor, Avatar, Box, Group, Image, Space, Stack, Table, Text } from "@mantine/core";
import { Stats } from "../components/Stats";
import { data } from "../data/contributions.json";
import React from "react";

export function Contributions({ year, contributions }: {
    year: string,
    contributions: {
        id: string, login: string, bio: string | null, avatarUrl: string, name: string | null,
        contributions: { permalink: string, title: string; name: string, url: string, owner: { login: string }, stargazers: { totalCount: number }, createdAt: string }[], score: number
    }[]
}) {
    return (
        <Stack spacing="sm">
